    ...
    def _get_palette(self, prefer_light_text: bool) -> dict:
        if prefer_light_text:
            return {
                ...
                "boxStroke": "rgba(102, 183, 255, 0.95)",
                "text": "rgba(242, 245, 248, 0.96)",
                "label": "rgba(255, 255, 255, 0.5)",
                "thinking": "rgba(210, 215, 224, 0.85)",
