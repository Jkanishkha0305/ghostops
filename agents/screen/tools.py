"""
GhostOps Agent Tools - Screen annotation capabilities.
...
def create_text(
    ...
    queue_action(
        ...
        (x, y, text, text_id, font_size, font_family, align, baseline, "ghostops"),
        {}
    )
...
def draw_pointer_to_object(
    ...
    queue_action(
        time,
        _create_text_non_overlapping,
        (text_x, text_y, text, text_id, 18, "Helvetica", "left", "top", "ghostops"),
        {},
    )
...
SCREEN_TOOLS = [types.Tool(function_declarations=[
    draw_bounding_box_declaration,
    draw_point_declaration,
    create_text_declaration,
    direct_response_declaration,
