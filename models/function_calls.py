...
# Import direct_response from GhostOps agent (used by both router and GhostOps)
...
invoke_screen_annotator_declaration = {
    "name": "invoke_screen_annotator",
    "description": "Delegate to GhostOps for screen annotation and explanation. Use when the user wants to understand something on their screen, needs visual explanation, or refers to 'this', 'that', 'here', etc.",
    "parameters": {
        "type": "object",
        "properties": {
            "query": {"type": "string", "description": "The user's query to pass to GhostOps."},
        },
        "required": ["query"],
    },
}
...
def invoke_screen_annotator(query: str):
    """Marker function - signals that ScreenAgent should be called."""
    pass
...
ROUTER_TOOL_MAP = {
    ...
    "invoke_screen_annotator": invoke_screen_annotator,
